...
// Functions to trigger the both motors using PWM
...
// Functions to set and update both motor's duty cycle
...
// Functions to get the current duty cycle of both motors
